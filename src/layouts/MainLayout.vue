<template>
  <q-layout view="hHh lpR fFf">
    ...
    <q-header class=" bg-white q-pt-lg">
      <div class="container">
        <div class="main_header flex items-center justify-around q-px-xl">
          <div class="header_logo" v-if="screenWidth >= 1024">
            <img src="~src/assets/logo-header.svg" alt="">
          </div>
          <div class="header_tabs Rubik500 " v-if="screenWidth >= 1024">
            <q-tabs
          ...
          <q-toolbar v-if="screenWidth <= 1024" class="flex justify-between">
            ...
            <a href="tel:+78005552239" class="text-blue no-margin header_phone_mob">8 (800) 555-22-39</a>
            <q-btn flat @click="drawer = !drawer" round dense icon="menu" color="red"/>
          </q-toolbar>
          <div class="header_phone flex items-center q-px-md">
            <div class="dpNone">
            ...
            <div class="q-pl-md Rubik500" v-if="screenWidth >= 1024">
              <a href="tel:+78005552239" class="text-blue no-margin header_phone_mob">8 (800) 555-22-39</a>
              <p class="text-accent dpNone">ежедневно 9:00 - 21:00</p>
            </div>
          </div>
          <div class="Rubik500 dpNone">
            <q-btn
                color="white"
                class="bg-blue anim_btn Rubik500"
                rounded
